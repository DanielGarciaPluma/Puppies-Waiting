# Diagrams ![MySQL](https://img.shields.io/badge/MySQL-005C84?style=for-the-badge&logo=mysql&logoColor=white)
 ...
 En esta sección se encontrarán archivos relacionados con representaciones visuales que muestran la estructura y relaciones entre las entidades (tablas), atributos (campos) y las restricciones de una base de datos, estos diagramas utilizan símbolos gráficos para ilustrar cómo están organizados y conectados los datos dentro del sistema.
