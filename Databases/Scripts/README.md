# Scripts ![MySQL](https://img.shields.io/badge/MySQL-005C84?style=for-the-badge&logo=mysql&logoColor=white)
 ...
 En esta sección se encontrarán archivos relacionados con  
  instrucciones o comandos escritos en un lenguaje específico (como SQL) que se utilizan para realizar diversas operaciones en una base de datos. Estas operaciones pueden incluir la creación de tablas, la definición de índices, la inserción de datos iniciales, la modificación de la estructura de la base de datos (alteraciones), la eliminación de objetos, la ejecución de consultas complejas, entre otras acciones.
